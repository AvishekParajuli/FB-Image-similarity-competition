...
#from models.baseline_nn import *
#from models.resnet_nn import *
#from models.resnet_nn_drop import *
#from models.resnet_vanilla import *
...
def getBestThreshold(probas_pred, y_true):
    ...
    w = {False: 1, True: 7.05}# change from 7 to 7.5 to see the effect(def:7.05)
    # define model
...
def generate_full_QueryEmbeddings(base_model_filename, outfileSuf ='_'):
    ...
    rimage_list, rids = getImIds('./list_files/subset_ref_extended',
                                 "C:/Users/parajav/PycharmProjects/isc/reference/reference")
