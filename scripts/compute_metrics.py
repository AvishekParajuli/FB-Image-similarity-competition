...
from isc.descriptor_matching import match_and_make_predictions, knn_match_and_make_predictions,orb_match_and_make_predictions
from isc.descriptor_matching import net_match_and_make_predictions
...
def compute_metrics_orb(args):
    ...
    predictions = orb_match_and_make_predictions(xq, query_image_ids,xb, db_image_ids,Max_Matches=1)
...
def compute_metrics_net(args):
    ...
    predictions = net_match_and_make_predictions(xq, query_image_ids,xb, db_image_ids,Max_Matches=1)
...
if __name__ == "__main__":
    ...
    if args.net:
        ...
        compute_metrics_orb(args)
    elif not args.track2:
